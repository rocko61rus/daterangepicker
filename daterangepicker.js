...
(function (root, factory) {
    if (window.moment) {
        root.daterangepicker = factory(window.moment, $);
    ...
    DateRangePicker.prototype = {
        ...
        move: function() {
            ...
            var minimalPosition = this.element.offset().top + this.element.outerHeight() + this.container.outerHeight() + 5;
            ...
            if (!MOBILE && $(window).scrollTop() + $(window).outerHeight() < minimalPosition) {
                this.drops = 'up';
            } else {
                this.drops = 'down';
            }
            ...
            if (this.opens == 'left') {
                ...
                if (navigator.browserSpecs.name == 'Safari' &&
                    navigator.browserSpecs.version == 11 &&
                    this.drops != 'up') {
                    containerTop -= 22;
                }
                this.container.css({
        ...
        show: function(e) {
            ...
            this.element.trigger('beforeOpen.daterangepicker', this);
